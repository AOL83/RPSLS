...
Feedback is always welcome, so here is mine im starting with my index.html page but the hole web page is written in HTML, CSS and JavaScript. The page is a game of Rock, Paper, Scissors, Lizard, Spock, from famous series the big bang theory which is an extension of the traditional game of Rock, Paper, Scissors.
